...
module.exports = {
  ...
  typography: {
    clay: {
      css: {
        '--tw-prose-body': 'rgb(var(--clay-charcoal-rgb))',
        '--tw-prose-headings': 'rgb(var(--clay-charcoal-rgb))',
        '--tw-prose-lead': 'rgb(var(--clay-charcoal-rgb) / 0.8)',
        '--tw-prose-links': 'rgb(var(--clay-coral-rgb))',
        '--tw-prose-bold': 'rgb(var(--clay-charcoal-rgb))',
        '--tw-prose-counters': 'rgb(var(--clay-sage-rgb))',
        '--tw-prose-bullets': 'rgb(var(--clay-sage-rgb))',
        '--tw-prose-hr': 'rgb(var(--clay-stone-rgb))',
        '--tw-prose-quotes': 'rgb(var(--clay-charcoal-rgb))',
        '--tw-prose-quote-borders': 'rgb(var(--clay-mint-rgb))',
        '--tw-prose-captions': 'rgb(var(--clay-charcoal-rgb) / 0.5)',
        '--tw-prose-code': 'rgb(var(--clay-coral-rgb))',
        '--tw-prose-pre-code': 'rgb(var(--clay-charcoal-rgb))',
        '--tw-prose-pre-bg': 'rgb(var(--clay-base-rgb))',
        '--tw-prose-th-borders': 'rgb(var(--clay-stone-rgb))',
        '--tw-prose-td-borders': 'rgb(var(--clay-sand-rgb))',
      },
    },
  },
}
