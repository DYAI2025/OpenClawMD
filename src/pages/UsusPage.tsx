...
export function UsusPage({ onBack, initialPostSlug }: UsusPageProps) {
  const posts = getEducationalPosts();
  const [selectedPost, setSelectedPost] = useState<BlogPost | null>(() => {
    if (initialPostSlug) {
      return posts.find(p => p.slug === initialPostSlug) || null;
    }
    return null;
  });
    ...
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <div className="mb-12">
        ...
        <p className="text-lg text-clay-charcoal/60 max-w-2xl">
          Educational deep-dives into autonomous systems, agent architectures, and the technical foundations of AI agency.
        </p>
      </div>
